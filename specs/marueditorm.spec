...
a = Analysis(['../marueditor.py'],
             ...
             hiddenimports=["babel", "pytz", "psutil", "babel.numbers", "numpy", "PIL", "PIL.ImageTk", "tkinter.tix","pydub", "tkinter.font", "imageio"],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
...
app = BUNDLE(exe,
             name='Marueditor.app',
             icon="../image/marueditor.icns",
             bundle_identifier="com.marusoftware.marutools.marueditor")
